    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        <div class="is-size-7 has-text-left content">
          ...
          <p>
            LASTWOLF管理人（以下，「管理人」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザのプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
          </p>
          ...
          <ol>
            <li>
              本サービスは，ユーザが利用登録をする際にTwitterアカウント名やユーザ名をお尋ねすることがあります。
            </li>
            <li>
          ...
          <p>
            管理人は，Twitterアカウント名やユーザ名以外のプライバシー情報について，次に掲げる場合を除いて，あらかじめユーザの同意を得ることなく提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。
          </p>
          <ol>
            <li>
