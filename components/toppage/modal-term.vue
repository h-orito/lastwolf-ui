  ...
  >
    <div class="modal-card">
      <header class="modal-card-head">
        <p class="modal-card-title has-text-left">利用規約</p>
      </header>
      <section class="modal-card-body">
        <div class="is-size-7 has-text-left content">
          <h3 class="is-size-6">利用規約</h3>
          <p>
            この利用規約（以下，「本規約」といいます。）は，LASTWOLF管理人（以下，「管理人」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザの皆さま（以下，「ユーザ」といいます。）には，本規約に従って，本サービスをご利用いただきます。
          </p>
          <h3 class="is-size-6">第1条（適用）</h3>
          <ol>
            <li>
          ...
          <h3 class="is-size-6">第2条（利用登録）</h3>
          <ol>
            <li>
          ...
          <h3 class="is-size-6">第3条（ユーザIDおよびパスワードの管理）</h3>
          <ol>
            <li>
          ...
          <h3 class="is-size-6">第5条（本サービスの提供の停止等）</h3>
          <ol>
            <li>
          ...
          <h3 class="is-size-6">第6条（利用制限および登録抹消）</h3>
          <ol>
            <li>
